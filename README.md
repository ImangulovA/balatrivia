...
## Rebuild the question bundle

```bash
python3 scripts/build_questions.py --selftest   # verify norm() parity
python3 scripts/build_questions.py --amount 500 # fetch & write app/src/lib/questions.json
```
...
Questions from the [Open Trivia Database](https://opentdb.com/), licensed
